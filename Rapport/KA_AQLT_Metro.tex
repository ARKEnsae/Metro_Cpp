...
\item
  ...
  le sommet de départ et ce sommet.
\end{enumerate}
...
\tightlist
\item
  A chaque itération, identifier tout d'abord les voisins restant à
...
\item
  ...
  que toutes les arêtes soient visitées. Il est alors possible en
  choisissant un sommet d'arrivée de retracer le chemin le plus court à
  parcourir et les distances parcourus entre chaque sommet.
\end{enumerate}

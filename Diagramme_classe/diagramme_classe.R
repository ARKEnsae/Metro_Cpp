...
tables <- data.frame("table" = c("Ligne","Arret","Metro","IHM","Itineraire","Edge","Node"),
                     "segment" = c("Métro","Métro",NA,NA,"Algorithme","Algorithme","Algorithme"),
                     "display" = c("accent1","accent1",NA,NA,"accent2","accent2","accent2"),
                     stringsAsFactors = FALSE
)

IHM <- data.frame("column" = c("+choixItineraire(metro : Metro)",
                               "+choixTypeItineraire()",
                               "+quitter()"),
...
columns <- rbind(Metro,IHM,Itineraire,Edge,Node,Ligne,Arret)
#columns <- rbind(Itineraire)
rm(Metro,IHM,Itineraire,Edge,Node,Ligne,Arret)

#references = NULL
references <- data.frame("table" = c("Ligne","Arret","Node","Ligne","Arret","Arret","Node","Edge","Itineraire","Metro"),
                         column=NA,
                         "ref" = c("Arret","Ligne","Edge","Metro","Metro","Node","Itineraire","Itineraire","Metro","IHM"),
                         "ref_col"=NA,
                         "ref_id" = 1,
                         "ref_col_num" = 1,
                         stringsAsFactors = FALSE)
